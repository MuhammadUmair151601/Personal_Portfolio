...
const Contact = () => {
  return (
    <section
      id="contact"
      className="h-full bg-gray-900 text-white flex flex-wrap"
    >
      ...
      <div className="flex w-full">
        <div className="w-1/2 bg-amber-800"></div>
        <div className=" w-1/2 ">
          ...
          <div className="w-full  h-1/6 p-8">
            ...
            <div className="flex gap-4 text-white ml-10 pt-3">
              <a
                href="https://github.com/MuhammadUmair151601"
                target="_blank"
                rel="noopener noreferrer"
                className="transition hover:text-black hover:bg-orange-400 rounded-[50%] h-10 w-10 flex items-center justify-center shadow-[0_0_25px_#f97316]"
              >
                <Github size={28} />
              </a>
